...
function showMsg(message) {
    ...
    document.getElementById("btnRow").style.visibility = "visible";
    document.getElementById("btnRow").style.display = "block";
    document.getElementById("largeDisplay").style.visibility = "collapse";
...
function closeDiag() {
    ...
    document.getElementById("btnRow").style.visibility = "collapse";
    document.getElementById("btnRow").style.display = "none";
    document.getElementById("largeDisplay").style.visibility = "visible";
